export const se = {
  translation: {
    ...
    hello: {
      h1: "Hej.",
      p1: "Jag är en nyfiken och engagerad frontend-utvecklare som älskar problemlösning och som brinner för att skapa moderna och användarvänliga webbapplikationer, både på uppdrag av en arbetsgivare eller i egenskap av privatperson där jag bygger spännande open source projekt på min fritid.",
      p2: "Jag är väl bevandrad i Javascript, CSS och SCSS, och även om jag för närvarande arbetar omfattande i Aurelia, är min huvudsakliga expertis inom React. Jag är en prestigelös och lösningsorienterad person och jag betraktar anpassningsförmåga som en av mina styrkor. Därför känner jag mig hemma i en dynamisk teammiljö där vi hjälper varandra och arbetar mot ett gemensamt mål.",
      p3: "Jag har en god analytisk förmåga, är nyfiken och har en ihållande törst efter kunskap. Jag strävar efter att ständigt utforska nya tekniker och bredda min kunskapsbas.",
    },
    ...
    education: {
      h1: "Utbildning.",
      p1: "2019 - 2021 Frontend-utveckling, Nackademin",
    },
    skills: {
      h1: "Kunskaper.",
      text: {
        h1: "Utvecklingsspråk / Frameworks",
        h2: "Projekt / utvecklingsmetoder",
      },
    },
    projects: {
      h1: "Personliga projekt.",
      scriptwave:
    ...
    contact: {
      emailBtn: "Maila mig",
      headline: "Kontakt.",
      text: "Om du har några frågor eller bara vill prata, tveka inte att kontakta mig.",
      name: "Ditt namn",
      email: "Din email address",
      message: "Ditt meddelande",
      send: "Skicka",
      validation: "Var god fyll i alla fält",
      success: "Ditt meddelande är skickat",
      error: "Ditt meddelande gick tyvärr inte att skicka",
    },
  },
};
